        ...
        <header className={
            ...
            <nav className={isMenu ? "flex mt-20" : "hidden lg:flex"}>
                <ul
                    ...
                    <li>
                        <a href="#" className="hover:text-purple-900" onClick={() => setIsMenu(false)}>Home</a>
                    </li>
                    <li>
                        <a href="#about" className="hover:text-purple-900" onClick={() => setIsMenu(false)}>Sobre</a>
                    </li>
                    <li>
                        <a href="#technologies" className="hover:text-purple-900" onClick={() => setIsMenu(false)}>Tecnologias</a>
                    </li>

                    <li>
                        <a href="#projects" className="hover:text-purple-900" onClick={() => setIsMenu(false)}>Projetos</a>
                    </li>
                    <li>
                        <a href="#contact" className="hover:text-purple-900 " onClick={() => setIsMenu(false)}>Contato</a>
                    </li>
                </ul>
            </nav>
        </header>
