    ...
    <section id="projects" className="pb-28 px-6 lg:px-12 lg-pt-28 xl:px-28 flex flex-col items-center">
      ...
      <div className="flex flex-col lg:grid lg:grid-cols-3 gap-6 mt-10">
        ...
        <div className="bg-[#2C243B] flex flex-col p-4 rounded-xl cursor-pointer justify-between">
          ...
          <div className="flex flex-col items-center gap-4 mt-4 sm:flex-row">
            <a
              href="https://film-lib.netlify.app/"
              target="_blank"
              className="bg-purple-900 hover:bg-purple-600 flex items-center text-white font-medium w-[100%] justify-between px-4 gap-4 py-2 rounded-lg lg:w-[50%]"
            >
              <TbWorld color="#ffffff" size={25} />
            ...
            <a
              href="https://github.com/liviaaraujo-dev/film-lib"
              target="_blank"
              className="bg-[#413A4F] hover:bg-[#675c7e] flex items-center text-white font-medium w-[100%] justify-between px-4 gap-4 py-2 rounded-lg lg:w-[50%]"
            >
              <FaGithub color="#ffffff" size={25} />
        ...
        <div className="bg-[#2C243B] flex flex-col p-4 rounded-xl cursor-pointer justify-between">
          <div>
            <img
              src="/images/lista-contatos.jpeg"
              alt="Lista de contatos"
              className="h-[50vh]"
            />
            <div className="flex items-start justify-start w-[100%] my-4 gap-1">
              <SiDart color="#7F4FEB" size="35" />
              <SiFlutter color="#7F4FEB" size="35" />
            </div>
            <h3 className="text-xl font-bold text-white">Lista de Contatos</h3>
            <p className="text-white text-base">
              App lista de contatos desenvolvido com flutter, os dados estão sendo salvos utilizando Back4App.
            </p>
          </div>
          <div className="flex flex-col items-center gap-4 mt-4 sm:flex-row">
            <a
              href="https://youtu.be/mtDP4NL5WuE/"
              target="_blank"
              className="bg-purple-900 hover:bg-purple-600 flex items-center text-white font-medium w-[100%] justify-between px-4 gap-4 py-2 rounded-lg lg:w-[50%]"
            >
              <TbWorld color="#ffffff" size={25} />
            ...
            <a
              href="https://github.com/liviaaraujo-dev/lista_de_contatos"
              target="_blank"
              className="bg-[#413A4F] hover:bg-[#675c7e] flex items-center text-white font-medium w-[100%] justify-between px-4 gap-4 py-2 rounded-lg lg:w-[50%]"
            >
              <FaGithub color="#ffffff" size={25} />
        ...
        <div className="bg-[#2C243B] flex flex-col p-4 rounded-xl cursor-pointer justify-betwee">
          <div>
            <img
              src="/images/jogo-velha.png"
              alt="Projeto Indecor"
              className="h-[50vh]"
            />
            <div className="flex items-start justify-start w-[100%] my-4 gap-2">
            ...
            <h3 className="text-xl font-bold text-white">Jogo da Velha</h3>
            <p className="text-white text-base">
          ...
          <div className="flex flex-col items-center gap-4 mt-4 sm:flex-row">
            <a
              href="https://github.com/liviaaraujo-dev/jogo_velha"
              target="_blank"
              className="bg-[#413A4F] hover:bg-[#675c7e] flex items-center text-white font-medium w-[100%] justify-between px-4 gap-4 py-2 rounded-lg lg:w-[50%]"
            >
              <FaGithub color="#ffffff" size={25} />
        ...
        <div className="bg-[#2C243B] flex flex-col p-4 rounded-xl cursor-pointer justify-betwee">
          <div>
            ...
            <h3 className="text-xl font-bold text-white">DevTodo</h3>
            <p className="text-white text-base">
